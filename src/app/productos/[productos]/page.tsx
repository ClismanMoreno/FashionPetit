...
const productos = [
  {
    ...
    url: 'pantalon-1',
    description:
      'Pantalón jean a la cintura de corte recto',
  },
  {
    id: 2,
    nombre: 'Marca Studio F',
    precio: 76.5,
    img: '/images/pan2.jpeg',
    cintura: 85,
    cadera: 92,
    largo_tiro: 30,
    pierna: 85,
    marca: 'Marca Studio F',
    url: 'pantalon-2',
    description:
      'Pantalón casual de talle alto con detalle de cinturón incorporado',
  },
  {
    id: 3,
    nombre: 'Pantalon 3',
